...
int main() {
    ...
    std::cout << std::endl;
    std::cout << "CREATION DE G1" << std::endl;
    ...
    if (DEBUG) std::cout << std::endl;
    std::cout << "AFFICHAGE DE G1" << std::endl;
    std::cout << graphe1;
    ...
    {
        std::cout << "CREATION DE G2" << std::endl;
        if (DEBUG) std::cout << std::endl;
    ...
    Graphe graphe3 = Graphe{ std::vector<Arete*> {}, std::vector<Sommet*> {} };
    {
        ...
        std::cout << "CREATION DE G4" << std::endl;
        if (DEBUG) std::cout << std::endl;
        Graphe graphe4 = Graphe{ std::vector<Arete*> {}, std::vector<Sommet*> {} };
        graphe4.ajouteArete("Y", "W", 7);
        if (DEBUG) std::cout << std::endl;
        std::cout << "AFFICHAGE DE G4" << std::endl;
        std::cout << graphe4;

        std::cout << std::endl;

        // On assigne le graphe temporaire au le graphe vide
        std::cout << "ASSIGNATION DE G4 A G3" << std::endl;
        if (DEBUG) std::cout << std::endl;
        graphe3 = Graphe{ graphe4 };
        if (DEBUG) std::cout << std::endl;
        std::cout << "SUPPRESSION DE G4" << std::endl;
        std::cout << std::endl;
    }
    std::cout << "AFFICHAGE DE G3" << std::endl;
    std::cout << graphe3;

    std::cout << std::endl;

    // On symetrise le graphe
    std::cout << "SYMETRISATION DE G3" << std::endl;
    if (DEBUG) std::cout << std::endl;
    graphe3.symetrise();
    if (DEBUG) std::cout << std::endl;
    std::cout << "AFFICHAGE DE G3" << std::endl;
    ...
    std::cout << "CREATION DE G5 A PARTIR DE G3" << std::endl;
    if (DEBUG) std::cout << std::endl;
    ...
    if (DEBUG) std::cout << std::endl;
    std::cout << "AFFICHAGE DE G5" << std::endl;
    std::cout << graphe5;
    ...
    **/
    ...
    std::cout << "CREATION DE G(k)" << std::endl;
    if (DEBUG) std::cout << std::endl;
    ...
    if (DEBUG) std::cout << std::endl;
    std::cout << "AFFICHAGE DE G(k)" << std::endl;
    std::cout << grapheK;
    std::cout << std::endl;
    std::cout << "CALCUL D'UN ARBRE COUVRANT MINIMAL DE G(k)" << std::endl;
    if (DEBUG) std::cout << std::endl;
    Graphe* acm = grapheK.kruskal();
    if (DEBUG) std::cout << std::endl;
    std::cout << "ARBRE COUVRANT MINIMAL" << std::endl;
    std::cout << *acm;
    if (DEBUG) std::cout << std::endl;
    std::cout << "SUPPRESSION DE l'A.C.M." << std::endl;
    delete acm;
    if (DEBUG) std::cout << std::endl << "FIN DU PROGRAMME, NETTOYAGE DES POINTEURS" << std::endl;
}